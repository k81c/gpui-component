...
When working on tasks related to these areas, Codex will automatically use the appropriate skill to provide specialized guidance and patterns.

## Testing Guidelines

See `.Codex/COMPONENT_TEST_RULES.md` for detailed testing principles:
